                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div>
                                <img src="{{asset('uploads/category/thumb/'.$category->image)}}" width="250px" alt="">
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" name="showNav" id="showNav">
                                        <option {{($category->showNav== 'Yes')?'selected':''}}  value="Yes">Yes</option>
                                        <option {{($category->showNav=='No')?'selected':''}}   value="No">No</option>
